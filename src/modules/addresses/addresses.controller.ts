...
export class AddressesController {
  ...
  @ApiResponse({ status: 200, description: 'Lista de endereços.', schema: { example: [ADDRESS_EXAMPLE] } })
  ...
  @ApiOperation({
    ...
    description: 'Se `isDefault: true`, desmarca todos os outros endereços do usuário antes de salvar.',
  })
  @ApiResponse({ status: 201, description: 'Endereço criado.', schema: { example: ADDRESS_EXAMPLE } })
  ...
  @ApiResponse({ status: 200, description: 'Endereço atualizado.', schema: { example: ADDRESS_EXAMPLE } })
  @ApiResponse(SwaggerResponses.badRequest)
  @ApiResponse(SwaggerResponses.unauthorized)
